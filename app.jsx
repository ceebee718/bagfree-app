...
const TILES = [
  ...
  { id:'secondjourney', title:'Second Journey™', desc:'Rent. Wear. Return. Repeat. Sustainable travel clothing delivered to your hotel.', icon:function(){return React.createElement('img',{src:'/images/second-journey-logo.png',style:{width:'48px',height:'48px',objectFit:'contain',filter:'drop-shadow(0 2px 6px rgba(0,0,0,0.4))'},alt:'Second Journey'})}, link:'/departure-lounge-landing.html?vendor=second-journey', img:'https://images.unsplash.com/photo-1490114538077-0a7f8cb49891?w=600&h=400&fit=crop', badge:'NEW' },
