  ...
  return (
    <div className="topbar">
      <div className="greeting">
        ...
        <div style={{fontSize:'0.92rem',color:'var(--muted)',fontWeight:300,marginTop:'1.5rem',marginBottom:'1.8rem',lineHeight:1.6,maxWidth:'520px'}}>Travel lighter, discover more, and help create a more sustainable way to explore the world.</div>
