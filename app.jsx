...
const TILES = [
  ...
  { id:'secondjourney', title:'Second Journey™', desc:'Rent. Wear. Return. Repeat. Sustainable travel clothing delivered to your hotel.', icon:function(){return React.createElement('img',{src:'/images/second-journey-logo.png',style:{width:'30px',height:'30px',objectFit:'contain'},alt:'Second Journey'})}, link:'/departure-lounge-landing.html?vendor=second-journey', img:'https://images.unsplash.com/photo-1532453288672-3a27e9be9efd?w=600&h=400&fit=crop', badge:'♻' },
