...
function Sidebar(props) {
  ...
  return (
    <aside className={'sidebar' + (props.mobileOpen ? ' sidebar--open' : '')}>
      ...
      <a href="https://apps.apple.com/us/app/bagfree/id6796845348" target="_blank" rel="noopener" className="sidebar-appbtn">
        ...
        <span className="sidebar-appbtn-text">
          <span className="sidebar-appbtn-eyebrow">Now on iOS</span>
          <span className="sidebar-appbtn-title">Download the App</span>
        </span>
      </a>
    ...
    <div className="topbar">
      <div className="greeting">
        <h1 className="greeting-title">
          <div style={{marginBottom:'0.6rem'}}>Travel Without Luggage.</div>
          <em style={{color:'var(--gold)',fontStyle:'italic',fontSize:'0.72em',display:'block',marginTop:'0.3rem'}}>Your Clothes Are Waiting at Your Hotel.</em>
        </h1>
