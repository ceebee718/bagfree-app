...
function QuoteSection() {
  return (
    <section className="why-bf">
      <div className="why-bf-inner">

        <div className="why-bf-left">
          <div className="why-bf-eyebrow">
            <span className="why-bf-diamond"></span>
            <span>Why BagFree</span>
          </div>
          <h2 className="why-bf-title">
            Travel lighter.<br/>
            <em>Arrive to everything.</em>
          </h2>
          <ul className="why-bf-values">
            <li className="why-bf-value">
              <span className="why-bf-check">✓</span>
              <span>Arrive Prepared</span>
            </li>
            <li className="why-bf-value">
              <span className="why-bf-check">✓</span>
              <span>Discover Like a Local</span>
            </li>
            <li className="why-bf-value">
              <span className="why-bf-check">✓</span>
            ...
            <li className="why-bf-value">
              <span className="why-bf-check">✓</span>
              <span>Travel More Sustainably</span>
            </li>
          </ul>
        </div>
        ...
        <div className="why-bf-right">
          ...
          <div className="why-bf-pillar">
            <div className="why-bf-pillar-icon">
              <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="3" y="7" width="18" height="13" rx="2"/><path d="M16 7V5a4 4 0 00-8 0v2"/></svg>
            </div>
            <div>
              <div className="why-bf-pillar-name">Travel Light</div>
              <div className="why-bf-pillar-desc">Arrive prepared with what you need. No checked bags, no overweight fees, no dragging luggage through airports.</div>
            </div>
          </div>

          <div className="why-bf-pillar">
            <div className="why-bf-pillar-icon">
              <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z"/><path d="M2 12h20"/></svg>
            </div>
            <div>
              <div className="why-bf-pillar-name">Experience More</div>
              <div className="why-bf-pillar-desc">Discover hidden gems and local favorites. Our bundles are curated for each destination.</div>
            </div>
          </div>

          <div className="why-bf-pillar">
            <div className="why-bf-pillar-icon">
              <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M7 19H4a1 1 0 01-1-1v-4a1 1 0 011-1h3m10 6h3a1 1 0 001-1v-4a1 1 0 00-1-1h-3"/><path d="M14 5.5a2.5 2.5 0 00-5 0C9 8 12 9 12 12c0-3 3-4 3-6.5z"/><path d="M12 12v7"/></svg>
            </div>
            <div>
              <div className="why-bf-pillar-name">Leave Less Behind</div>
              <div className="why-bf-pillar-desc">Make a positive impact wherever you go. Second Journey™ gives quality clothing a second life.</div>
            </div>
          </div>
