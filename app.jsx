...
const TILES = [
  ...
  { id:'snacks', title:'Snacks & Drinks', desc:'Handpicked favorites for your stay.', icon:Icon.Cup, link:'/legacy.html#essentials', img:'https://images.unsplash.com/photo-1599490659213-e2b9527bd087?w=600&h=400&fit=crop' },
  ...
  return (
    <div className="topbar">
      <div className="greeting">
        <div className="greeting-sub">Good Morning, Olivia <Icon.Sun/></div>
        <h1 className="greeting-title">Welcome to {props.city.name}</h1>
  ...
  return (
    <section className="video-section">
      ...
      <div className="video-frame">
        <iframe
          src="https://player.vimeo.com/video/1195690381?badge=0&autopause=0&player_id=0&app_id=58479"
